...
DEG_list <- readLines("~/Documents/PhD/Parkinsons/Parkinsons_Code/Results/FamilialBlood_Correct/ALS_sfblood_ALLgenes.txt")
...
write.csv(DEG_PPI, "DEG_PPI_famBlood_correct.csv", row.names = F)
...
DEG_PPI <- read.csv("DEG_PPI_famBlood_correct.csv")
...
AR_PPI <- readLines("ArthritisPPI.txt")
# AFTER DOWNLOADING NODE TABLE FROM CYTOSCAPE #
