...
#r <- readLines("/Users/clairegreen/Documents/PhD/TDP-43/TDP-43_Code/Results/PPI_Network/Coexpression/PPI_Coexpression/CorrelationValue/RMETHOD/RPT_edgeperm_result.txt")
r <- as.numeric(r)
exp <- 95

test1 <- which(r > exp)  # count number of times r is larger than test value
