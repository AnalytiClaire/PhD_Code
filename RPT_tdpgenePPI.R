...
genelist <- read.csv("~/Documents/PhD/TDP-43/TDP-43_Code/Results/Benchmarks3.csv")
genelist <- as.character(genelist$Disgenes)
...
setwd("~/Documents/PhD/TDP-43/TDP-43_Code/Results/FIXEDSTUFF/Coexpression/")
...
write.csv(PPI_All, "TDPdisgenes_PPI.csv", row.names = F, quote = F)
...
disgenePPI <- read.csv("TDPdisgenes_PPI.csv")
...
#Create list of interactome genes with disease genes removed
...
m = 1000000
#Number of nug-disease edges in experimental interaction network
nug <- 205
